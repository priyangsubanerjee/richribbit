        ...
        <div className="flex items-center mt-16 space-x-8">
          <div className="w-[520px] h-[425px] relative">
            ...
            <div className="absolute inset-0 h-full w-full p-6">
              <h1 className="text-center text-xl text-white font-semibold font-poppins mt-2">
                STAKING CALCULATOR
              </h1>
              <div className="flex items-center justify-between mt-8">
                <div className="flex flex-col justify-center items-start">
                  ...
                  <h1 className="text-3xl font-bold text-white mt-1">100</h1>
                </div>
              ...
              <div className="mt-10 space-y-6">
                <div className="grid grid-cols-3 w-full">
                  <p className="text-sm text-left text-[#ACACAC] tracking-widest">
                    YEARLY
                  </p>
                  <p className="text-sm text-center text-[#ACACAC] tracking-widest">
                    0.03 $FRGST
                  </p>
                  <p className="text-sm text-[#ACACAC] tracking-widest text-right">
                    $2.51
                  </p>
                </div>
                <div className="grid grid-cols-3 w-full">
          ...
          <div className="w-[520px] h-[425px] relative">
            ...
            <div className="absolute inset-0 h-full w-full p-6">
              <div className="flex items-center justify-between font-poppins">
                <h1 className="text-center text-base text-white font-medium font-poppins mt-2">
                  Results over a year
                </h1>
